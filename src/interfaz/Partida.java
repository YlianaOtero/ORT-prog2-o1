...
public class Partida {
    ...
    public Color colorCorrespondiente(char ficha) {
        Color colorCorrespondiente = new Color();
        
        switch (ficha) {
            case 'A' -> colorCorrespondiente.setColor("azul");
            case 'R' -> colorCorrespondiente.setColor("rojo");
        }
    ...
    public String letraPintada(char letra, Color color) {
        String codigo = color.getCodigo();
        return codigo + letra;
    }
    
    public String letraBordeTablero(int fila) {
        String letra;
    ...
    public void mostrarTableroActual() {
